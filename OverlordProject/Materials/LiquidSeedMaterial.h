...
class LiquidSeedMaterial : public Material
{
public:
	LiquidSeedMaterial();
	virtual ~LiquidSeedMaterial() = default;
	LiquidSeedMaterial(const LiquidSeedMaterial& other) = delete;
	LiquidSeedMaterial(LiquidSeedMaterial&& other) noexcept = delete;
	LiquidSeedMaterial& operator=(const LiquidSeedMaterial& other) = delete;
	LiquidSeedMaterial& operator=(LiquidSeedMaterial&& other) noexcept = delete;
...
private:
	...
	/* These lines crash the initialisation if I uncomment them..
	ID3D11ShaderResourceView* m_pVelocitySRV = nullptr;
	ID3D11ShaderResourceView* m_pPressureSRV = nullptr;
	ID3D11ShaderResourceView* m_pColorSRV = nullptr;
	ID3D11ShaderResourceView* m_pVelocity2SRV = nullptr;
