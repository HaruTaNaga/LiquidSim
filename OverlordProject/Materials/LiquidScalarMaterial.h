...
class LiquidScalarMaterial : public Material
{
public:
	LiquidScalarMaterial();
	virtual ~LiquidScalarMaterial() = default;
	LiquidScalarMaterial(const LiquidScalarMaterial& other) = delete;
	LiquidScalarMaterial(LiquidScalarMaterial&& other) noexcept = delete;
	LiquidScalarMaterial& operator=(const LiquidScalarMaterial& other) = delete;
	LiquidScalarMaterial& operator=(LiquidScalarMaterial&& other) noexcept = delete;
